...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-3 [--cell-radius:100%] [--cell-size:--spacing(8)] bg-background group/calendar [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
