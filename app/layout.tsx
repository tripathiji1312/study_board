      ...
      >
        <AuthProvider>
          <ThemeProvider
            ...
            themes={["light", "dark", "system", "theme-purple", "theme-pink", "theme-pink-dark", "theme-midnight", "theme-forest", "theme-sunset", "theme-cyberpunk", "theme-coffee", "theme-nordic", "theme-cosmic", "theme-retro-pop", "theme-candy"]}
          >
            <StarfieldBackground />
            <XPProvider>
              <SWRProvider>
