...
import { IconBrandGoogle, IconBrandGithub, IconLoader, IconRocket } from "@tabler/icons-react"
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-background p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-accent/10 rounded-full blur-[120px] translate-x-1/4 -translate-y-1/4" />
